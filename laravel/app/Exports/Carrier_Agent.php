...
class Carrier_Agent implements FromCollection, WithCustomCsvSettings, WithHeadings
{

    function __construct($agent, $lokasi, $start_date, $end_date) {
        $this->agent = $agent;
        $this->lokasi = $lokasi;
    ...
    */
    public function collection()
    {
        ...
        ->where('lokasi', $this->lokasi)->whereBetween('tanggal',[ $this->start_date, $this->end_date])->where('agent', $this->agent)
