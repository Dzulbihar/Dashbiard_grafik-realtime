    ...
    series: [
      {
         ...
         // color: '#0002d5',
          data:<?php echo json_encode($grafik_arus_kunjungan_kapal_domestik_tahun_lalu)?>
      },
      {
          name: '<?php echo $tahun_ini; ?>',
      //    color: '#0fc902',
          data:<?php echo json_encode($grafik_arus_kunjungan_kapal_domestik_tahun_ini)?>
      }, 
      {
          name: 'RKAP',
       //   color: '#ff0a18',
          data:<?php echo json_encode($grafik_arus_kunjungan_kapal_domestik_rkap)?>
      }
    ]
});
</script>
