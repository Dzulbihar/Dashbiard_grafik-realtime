...
<script type="text/javascript">
  const chart = new Highcharts.Chart({
    ...
    series: [{
        ...
        color: '#93c47d',
        data:<?php echo json_encode($grafik_arus_petikemas_domestik_pendapatan_tahun_lalu)?>
    }, {
        name: '<?php echo $tahun_ini ?>',
        color: '#ff9566',
        data:<?php echo json_encode($grafik_arus_petikemas_domestik_pendapatan_tahun_ini)?>
    }
    , {
        name: 'RKAP',
        color: '#ff0a18',
        data:<?php echo json_encode($grafik_arus_petikemas_domestik_pendapatan_rkap)?>
    }
    ]
  });
</script>