...
Highcharts.chart('grafik_arus_petikemas_teus_international', {
    ...
    series: [{
        ...
        color: '#fc543a',
        data:<?php echo json_encode($grafik_arus_petikemas_international_teus_tahun_lalu)?>
    }, {
        name: '<?php echo $tahun_ini ?>',
        color: '#ffd966',
        data:<?php echo json_encode($grafik_arus_petikemas_international_teus_tahun_ini)?>
    }, {
        name: 'RKAP',
        color: '#93c47d',
        data:<?php echo json_encode($grafik_arus_petikemas_international_teus_rkap)?>
    }
    ]
