            ...
            <form action="" method="get">
              <div class="row g-3 align-items-center">
                ...
                <div class="col-auto">
                  ...
                  <a href="{{url('/bina_pelanggan_agen_pelayaran_mlo')}}" class="btn btn-primary" type="submit">Reset</a>
                </div>
              </div>
            </form>
...
@else
  <!-- Grafik -->
  @include('bina_pelanggan.agen_pelayaran.mlo.mlo_grafik')

  <!-- Tabel -->
  @include('bina_pelanggan.agen_pelayaran.mlo.mlo_datatabel')
@endempty
