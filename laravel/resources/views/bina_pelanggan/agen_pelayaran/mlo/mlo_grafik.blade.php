...
<script type="text/javascript">
    ...
    function get_chart_mlo() {
        $.ajax({
            url: "{{url('/grafik_ajax/bin_pel_mlo')}}",
            type: "GET",
            data: {
...
<script type="text/javascript">
    ...
    chart_mlo = new Highcharts.chart('grafik_mlo_binpel', {
        chart: {
