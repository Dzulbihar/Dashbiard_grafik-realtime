      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"> 
              <b> Real time produksi pendapatan Pemilik Barang
              </b>
            </h3>
            <p align="right">
                @empty ($start_date)
          ...
          <div class="card-body">
            ...
            <a href="{{url('excel_pemilik_barang')}}/{{($start_date)}}/{{($end_date)}}" target="_blank" class="btn btn-default btn-sm">
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    serverSide: true,
    ajax: {
      url:  "{{ route('bina_pelanggan_pemilik_barang') }}",
      data: {
