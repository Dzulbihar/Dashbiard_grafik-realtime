@section('header', 'Kunjungan Kapal Domestik')
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <form action="{{url('/cari_arus_kunjungan_kapal_domestik')}}" method="GET">
              <p class="card-title"> 
                <b>Tahun</b> 
                ...
                <!-- <a href="javascript:location.reload(true)" class="btn btn-default btn-sm"> Sync </a> -->
                <?php 
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            ...
            @include('arus.kunjungan_kapal.domestik_grafik')
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
            ...
            @include('arus.kunjungan_kapal.domestik_tabel')
