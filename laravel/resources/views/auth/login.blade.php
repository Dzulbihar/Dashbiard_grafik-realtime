...
<head>
    ...
    <title> EIS-TPK Semarang </title>
    <link rel="shortcut icon" href="{{asset('logo/logo_tpks.png')}}">
    <style type="text/css">
        body {
            padding: 0;
            margin: 0;
            background-image: url("{{asset('logo/kapal.jpeg')}}");
        ...
        .password {
            ...
            border: none;
            color: white;
            background-color: rgba(254, 190, 140, 1.0);
            margin-bottom: 15px;
            transition: ,5s;
        }
        ...
        .submit {
            width: 150px;
            padding: 10px;
            background-color: rgba(254, 208,73, 1.0);
            border-radius: 10px;
            font-weight: bold;
            color: white;
            border: none;
   ...
   <form action="{{route('login')}}" method="post" class="box">
    @csrf
       ...
       <h5 align="center"> 
        ...
        <img align="center" src="{{asset('logo/pelindo.png')}}" alt="" width="250" height="80"/>
    </div>
