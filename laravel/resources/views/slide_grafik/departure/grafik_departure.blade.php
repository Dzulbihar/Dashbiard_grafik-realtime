        ...
        data:
            ...
            <?php 
              $query2 = oci_parse($koneksi,     
                " 
                SELECT SUM($satuan) AS SATUAN, BULAN_DEPARTURE FROM DASHBOARDGRAFIK.PROD_PEND_PERCUSTOMER 
        ...
        data: 
            ...
            <?php 
              $query4 = oci_parse($koneksi,     
                " 
                SELECT TARGET_RKAP, BULAN FROM DASHBOARDGRAFIK.TARGET_RKAP_PERBULAN 
    ...
    series: [{
        ...
        data: 
            ...
            <?php 
              $query4 = oci_parse($koneksi,     
                " 
                SELECT SUM(TARGET_RKAP) AS TARGET_RKAP, BULAN FROM DASHBOARDGRAFIK.TARGET_RKAP_PERBULAN 
